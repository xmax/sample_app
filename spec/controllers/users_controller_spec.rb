	...
	describe "GET 'index'" do
		...
		describe "for signed-in users" do
			before( :each ) do
				...
				second = Factory( :user, :name => "Bob", :email => "user1@example.com")
				third  = Factory( :user, :name => "Ben", :email => "user2@example.com")
...
#===========================================================
	...
	describe "GET 'show'" do
		...
		it "should show the user's micropost" do
			...
			mp2 = Factory( :micropost, :user => @user, :content => "Baz foo" )
			get :show, :id => @user
...
#================================================    
	...
	describe "PUT 'update'" do
		...
		describe "failure" do
			...
			it "should render the 'edit' file" do
...
#================================================
	...
	end #describe "authentication of edit/update page"
